...
<div class="top-bar d-none d-md-block">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-3 align-items-center">
            <nav class="top-bar-nav" aria-label="روابط سريعة">
                <a href="{{ route('frontend.about') }}" class="top-bar-link {{ request()->routeIs('frontend.about') ? 'is-active' : '' }}">من نحن</a>
                <span class="top-bar-nav__sep" aria-hidden="true"></span>
                <a href="{{ route('frontend.contact') }}" class="top-bar-link {{ request()->routeIs('frontend.contact') ? 'is-active' : '' }}">اتصل بنا</a>
            </nav>
...
<nav class="navbar navbar-expand-lg main-nav glass-nav" id="siteMainNav" aria-label="التنقل الرئيسي">
    <span class="main-nav__accent-line" aria-hidden="true"></span>

    <div class="container main-nav__container">
        <div class="main-nav__topbar">
            <a class="navbar-brand main-nav__brand" href="{{ url('/') }}">
                @if($siteLogoUrl)
                    <img src="{{ $siteLogoUrl }}" alt="{{ $siteName }}" class="main-nav__brand-logo" width="44" height="44">
                @else
                ...
                <span class="main-nav__brand-text">
                    ...
                    <span class="main-nav__brand-tag">متجر رقمي</span>
                </span>
            </a>
        ...
        <div class="collapse navbar-collapse main-nav__collapse" id="mainNav" data-bs-scroll="false">
            <ul class="navbar-nav main-nav__menu mx-lg-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('frontend.home') ? 'active' : '' }}" href="{{ route('frontend.home') }}">
                        <span class="main-nav__link-inner">
                            <i class="fas fa-house main-nav__link-icon" aria-hidden="true"></i>
                            <span>الرئيسية</span>
                        </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('frontend.shop.*') ? 'active' : '' }}" href="{{ route('frontend.shop.index') }}">
                        <span class="main-nav__link-inner">
                            <i class="fas fa-cube main-nav__link-icon" aria-hidden="true"></i>
                            <span>المنتجات</span>
                        </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('frontend.categories.*') ? 'active' : '' }}" href="{{ route('frontend.categories.index') }}">
                        <span class="main-nav__link-inner">
                            <i class="fas fa-layer-group main-nav__link-icon" aria-hidden="true"></i>
                            <span>التصنيفات</span>
                        </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('frontend.blog.*') ? 'active' : '' }}" href="{{ route('frontend.blog.index') }}">
                        <span class="main-nav__link-inner">
                            <i class="fas fa-newspaper main-nav__link-icon" aria-hidden="true"></i>
                            <span>المدونة</span>
                        </span>
                    </a>
                </li>
            ...
            <form class="main-nav__search d-none d-lg-flex" action="{{ route('frontend.shop.index') }}" method="GET" role="search">
                ...
                <div class="main-nav__search-field">
                    ...
                    <input
                        ...
                        placeholder="ابحث عن برنامج، مفتاح، أو اشتراك..."
                        value="{{ $headerSearchQuery }}"
                        autocomplete="off"
                    >
                    <kbd class="main-nav__search-kbd d-none d-xl-inline">Ctrl+K</kbd>
            ...
            <div class="main-nav__actions">
                ...
                <a href="{{ route('frontend.cart.index') }}" class="main-nav__cart-cta d-none d-lg-inline-flex {{ request()->routeIs('frontend.cart.*', 'frontend.checkout.*') ? 'is-active' : '' }}" aria-label="سلة التسوق">
                    <span class="main-nav__cart-cta-icon"><i class="fas fa-shopping-bag"></i></span>
                    <span class="main-nav__cart-cta-text">السلة</span>
                    <span class="cart-badge main-nav__cart-cta-badge" data-initial-count="{{ $headerCartCount }}">{{ $headerCartCount }}</span>
                </a>
                ...
                @auth
                    ...
                    <div class="dropdown main-nav__user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end main-nav__dropdown">
                            <li><a class="dropdown-item" href="{{ route('frontend.account') }}"><i class="fas fa-gauge-high"></i> لوحة التحكم</a></li>
            ...
            <nav class="main-nav__secondary d-lg-none w-100" aria-label="روابط إضافية">
                <a href="{{ route('frontend.about') }}" class="main-nav__secondary-link {{ request()->routeIs('frontend.about') ? 'is-active' : '' }}">
                    <i class="fas fa-circle-info" aria-hidden="true"></i> من نحن
                </a>
                <a href="{{ route('frontend.contact') }}" class="main-nav__secondary-link {{ request()->routeIs('frontend.contact') ? 'is-active' : '' }}">
                    <i class="fas fa-envelope" aria-hidden="true"></i> اتصل بنا
                </a>
            </nav>
