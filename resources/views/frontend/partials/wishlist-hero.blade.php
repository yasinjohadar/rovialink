<div class="page-hero">
    <div class="page-hero-content container">
        <div class="page-hero-icon"><i class="fas fa-heart"></i></div>
        <h1 class="page-hero-title">قائمة المفضلة</h1>
        <p class="page-hero-subtitle">احفظ المنتجات التي تعجبك وأضفها للسلة وقتما تشاء.</p>
        <nav class="page-hero-breadcrumb" aria-label="breadcrumb">
            <a href="{{ route('frontend.home') }}">الرئيسية</a>
            <i class="fas fa-chevron-left sep"></i>
            <span class="current">قائمة المفضلة</span>
        </nav>
    </div>
