                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="show_on_homepage" id="show_on_homepage" value="1" {{ old('show_on_homepage', $brand->show_on_homepage) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="show_on_homepage">عرض في شريط الصفحة الرئيسية</label>
                                </div>
                                <small class="text-muted d-block mt-1">يجب وجود صورة الشعار ليظهر في الشريط المتحرك.</small>
                            </div>
                            <div class="col-12">
