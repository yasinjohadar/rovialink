                    ...
                    <ul class="main-menu">
                        @php
                            ...
                            $systemActive = request()->routeIs(
                                'admin.roles.*', 'admin.users.*', 'admin.system-status.*', 'admin.site-settings.*',
                                'admin.activity-log.*', 'admin.settings.email.*', 'admin.email-templates.*',
                                'admin.storage.*', 'admin.storage-disk-mappings.*', 'admin.backups.*',
                                'admin.backup-schedules.*', 'admin.backup-storage.*', 'admin.ai.*'
                            );
                        @endphp
                        ...
                        <li class="slide has-sub {{ $systemActive ? 'open active' : '' }}">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide {{ request()->routeIs('admin.settings.email.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.settings.email.index') }}" class="side-menu__item">إعدادات البريد (SMTP)</a>
                                </li>
                                ...
                                <li class="slide {{ request()->routeIs('admin.storage.index', 'admin.storage.create', 'admin.storage.analytics') ? 'active' : '' }}">
                                    <a href="{{ route('admin.storage.index') }}" class="side-menu__item">التخزين السحابي</a>
                                </li>
                                ...
                                <li class="slide {{ request()->routeIs('admin.backups.index', 'admin.backups.create', 'admin.backups.show', 'admin.backups.edit') ? 'active' : '' }}">
                                ...
                                <li class="slide {{ request()->routeIs('admin.backups.create') ? 'active' : '' }}">
                                    <a href="{{ route('admin.backups.create') }}" class="side-menu__item">إنشاء نسخة احتياطية</a>
                                </li>
                                <li class="slide {{ request()->routeIs('admin.backup-schedules.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.backup-schedules.index') }}" class="side-menu__item">جداول النسخ الاحتياطي</a>
                                </li>
                                <li class="slide {{ request()->routeIs('admin.backup-storage.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.backup-storage.index') }}" class="side-menu__item">إعدادات نسخ احتياطي</a>
                                </li>
                                <li class="slide {{ request()->routeIs('admin.ai.models.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.ai.models.index') }}" class="side-menu__item">نماذج الذكاء الاصطناعي</a>
                                </li>
                                <li class="slide {{ request()->routeIs('admin.ai.settings.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.ai.settings.index') }}" class="side-menu__item">إعدادات الذكاء الاصطناعي</a>
                                </li>
                            </ul>
                        </li>
